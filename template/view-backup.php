    ...
    <div>
        ...
        <div class="block-content" style="margin-top:20px;">
            <div style="padding-top: 10px;"> 
                ...
                <p style="width: 100%; float: left; margin-top: 5px; margin-bottom: 0px;">Automatic backups of your website and database occur every 24 hours. View more information in the <a href="https://codeguard.com/login" target="_blank" style="color: #95C93D;" class="visit_dash">CodeGuard dashboard.</a></p>
                <!--
                ...
                <div id="upgrade-prompt" style="display: <?php echo $error_count > UPGRADE_PROMPT_ERROR_THRESHOLD ? 'block' : 'none'?>;">
                    <b><span id="error-count"><?php echo $error_count?></span></b> consecutive errors have occurred during your recent backups. If errors continue to occur, you may be a good candidate for one of CodeGuard's direct plans. Please visit the <a href="http://support.codeguard.com/customer/portal/articles/2102833">CodeGuard support center</a> for more information.
                </div>
            ...
            <div class="success-message" id="backup-message" style="display: none; float:left; clear: both; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;">
                <p style="font-size: 13px; color: #5A5A5A; text-align: left; margin: 0px;">A backup has started! This may take a few moments.</p>
            </div>
            <div class="success-message" id="restore-message" style="display: none; float:left; clear: both; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;">
                <p style="font-size: 13px; color: #5A5A5A; text-align: left; margin: 0px;">A restore has started! This may take a few moments.</p>
            </div>
            <div id="action-buttons" style="">
                <div style="float: left; margin-top: 20px; clear: both;">
                    <button style="width: 167px; min-width: 167px; max-width: 167px; height: 46px; min-height: 46px; max-height: 46px; color: #fff;" onclick="start_backup('s3')" class="backup_button">Create Backup</button>
                </div>
        ...
        <a href="javascript:void(0);" style="<?php echo isset($amazon_option['codeguard_key']) ? '' : 'display:none;'?>" class="update_settings">Update Settings</a>
        </div>
    </div>
